...
public class Userportrait extends Activity implements TextToSpeech.OnInitListener{
    ...
    public void onInit(int i) {
        ...
        textToSpeech.speak("user portrait activated for you..",TextToSpeech.QUEUE_ADD,null,null);
       finish();
    }
}
